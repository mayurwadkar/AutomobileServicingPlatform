...
<spring:url var="url6" value="/user/logout"></spring:url>
	<header>
		<nav class="navbar navbar-dark bg-dark">
			<a href="http://localhost:8080/asp_jsp/customer/home"  class="navbar-brand">M2M Servicing
				Center</a>
	...
	<spring:url var="url2" value="/customer/editprofile"></spring:url>
	<spring:url var="url3" value="/customer/changepassword"></spring:url>
