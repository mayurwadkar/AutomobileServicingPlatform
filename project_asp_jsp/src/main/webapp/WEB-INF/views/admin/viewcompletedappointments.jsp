...
<header>
	...
	<div class="jumbotron" style="height: 100%">
		...
		<spring:url var="url5" value="/admin/generatebill"></spring:url>
		<h4>
			<a href="${url1}" class="btn btn-outline-info ">Back</a>
		</h4>
		<h4 style="color: red;">${noappmsg}</h4>
		<h4 style="color: green;">${pmsg}</h4>
		<table class="table table-hover">
			<caption>Completed APPOINTMENTS</caption>
			<thead>
			<tr align="center">
			...
			<c:forEach var="a" items="${requestScope.appointment_details}">
				<tr align="center">
					...
					<td><a href="generatebill?id=${a.id}">View Bill</a></td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
