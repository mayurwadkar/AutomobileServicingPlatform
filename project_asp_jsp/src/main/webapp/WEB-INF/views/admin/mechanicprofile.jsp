...
<body>
	...
	<spring:url var="url1" value="/admin/viewmechanics"></spring:url>
		<spring:url var="url2"
			value="/admin/editmechanicprofile?id=${user_details.id}"></spring:url>
	<spring:url var="url3"
		value="/admin/changepassword?id=${user_details.id}"></spring:url>
