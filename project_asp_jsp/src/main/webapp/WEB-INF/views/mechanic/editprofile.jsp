										...
										<div class="col-lg-6">
											<div class="p-4">
												<h2 class="fw-normal mb-4"
													style="color: blue; font-family: fantasy;">Update Mechanic
													</h2>
													...
													<div class="col-md-6 mb-4 pb-2">
														...
														<div class="form-outline">
															<input type="text" name="fname"
																...
																value="${mechanic_details.firstName}" />
														</div>
													</div>
													<div class="col-md-6 mb-4 pb-2">
														...
														<div class="form-outline">
															<input type="text" name="lname"
																...
																value="${mechanic_details.lastName}" />
														</div>
													</div>
												</div>
												<div class="mb-4 pb-2">
												...
												<div class="mb-4 pb-2">
													<div class="form-outline">
														<input type="text" name="mb"
															...
															value="${mechanic_details.mobileNumber}" />
													</div>
												</div>
												<div class="mb-2 pb-2">
													<div class="form-outline">
												...
												<div class="mb-4 pb-2">
													<div class="form-outline">
														<input type="text" name="ws"
															...
															value="${mechanic_details.workingStatus}" readonly="readonly"/>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="mb-4 pb-2">
													<div class="form-outline form-white">
														<input type="text" name="address"
															class="form-control form-control-lg"
															placeholder="Address"
															value="${mechaddress_details.address}" />
													</div>
												</div>
												<div class="mb-4 pb-2">
													<div class="form-outline form-white">
														<input type="text" name="house"
															...
															value="${mechaddress_details.houseNo}" />
													</div>
												</div>
												<div class="mb-4 pb-2">
													<div class="form-outline form-white">
														<input type="text" name="landmark"
															...
															value="${mechaddress_details.landmark}" />
													</div>
												</div>
												<div class="row">
													<div class="col-md-6 mb-4 pb-2">
														...
														<div class="form-outline form-white">
															<input type="text" name="city"
																...
																value="${mechaddress_details.city}" />
														</div>
													...
													<div class="col-md-6 mb-4 pb-2">
														...
														<div class="form-outline form-white">
															<input type="text" name="dist"
																...
																value="${mechaddress_details.district}" />
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-6 mb-4 pb-2">
														...
														<div class="form-outline form-white">
															<input type="text" name="zipcode"
																class="form-control form-control-lg"
																placeholder="Zipcode"
																value="${mechaddress_details.zipCode}" />
														</div>
													</div>
													<div class="col-md-6 mb-4 pb-2">
