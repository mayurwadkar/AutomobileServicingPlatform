...
<spring:url var="url6" value="/user/logout"></spring:url>
	...
	<div class="jumbotron" style="height: auto;">
		...
		<spring:url var="url1" value="/"></spring:url>
										...
										<div class="col-lg-6">
											<div class="p-4">
												<h2 class="fw-normal mb-4"
													style="color: blue; font-family: fantasy;">Customer
													Registration</h2>
												...
												<div class="mb-4 pb-2">
													<div class="form-outline">
														<input type="password" name="cpass"
															class="form-control form-control-lg"
															placeholder="Confirm password" title="Must match with password" required/>
													</div>
												</div>
												<div class="mb-4 pb-2">
													<div class="form-outline">
														<input  type="tel" name="mb"  pattern="[0-9]{10}" title="Must have 10 digit"
															class="form-control form-control-lg"
